                    ...
                    for xml_filename in main_xml_files:
                        if os.path.exists(xml_filename):
                            ...
                            try:
                                ...
                                # Only remove orphaned jobs and update modified jobs
                                # Missing jobs should only be added during scheduled processing
...
<head>
    ...
    <title>Apply for {decoded_title} - STSI Group</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <style>
        body {{
            background: linear-gradient(135deg, #003d4d 0%, #00B5B5 100%);
            min-height: 100vh;
        ...
        .btn-submit {{
            ...
            box-shadow: 0 4px 6px rgba(0, 181, 181, 0.2);
        }}
        .btn-submit:hover {{
            background: linear-gradient(135deg, #008080, #006666);
            transform: translateY(-2px);
            box-shadow: 0 6px 12px rgba(0, 181, 181, 0.3);
            color: white;
        }}
        .form-control {{
            border-radius: 8px;

...
| **Green (Success)** | `#22c55e` | `rgba(34, 197, 94, 0.15)` |
...
.alert-success { background: linear-gradient(145deg, rgba(34, 197, 94, 0.15), rgba(16, 185, 129, 0.1)); border-color: rgba(34, 197, 94, 0.3); }

...
- July 24, 2025. COMPLETE JOB 32658 DATA FIX - Updated job 32658 with complete Bullhorn data: location (Ottawa, ON, Canada), employment type (Direct Hire), remote type (Hybrid), and assigned recruiter (Sam Osman), resolving empty field issue where new jobs weren't getting complete data extraction from Bullhorn API

...
- **Qualified Indeed campaign tags (Sep 25)**: Columbus-Key now publishes as `#INDCol` (same as Columbus). Columbus-KIT stays `#INDCon`. The next Indeed republish rewrites the tag on those job descriptions.

...
bullhorn_bp = Blueprint('bullhorn', __name__)


@bullhorn_bp.route('/bullhorn')
@login_required
...
@bullhorn_bp.route('/test-bullhorn')
...
@bullhorn_bp.route('/bullhorn/create', methods=['GET', 'POST'])
@login_required
    ...
    if request.method == 'POST':
        try:
            ...
            if not name or not monitor_type:
                ...
                return redirect(url_for('bullhorn.create_bullhorn_monitor'))
...
@bullhorn_bp.route('/bullhorn/monitor/<int:monitor_id>')
...
@bullhorn_bp.route('/bullhorn/monitor/<int:monitor_id>/delete', methods=['POST'])
...
@bullhorn_bp.route('/bullhorn/monitor/<int:monitor_id>/test', methods=['POST'])
...
@bullhorn_bp.route('/api/bullhorn/monitor/<int:monitor_id>/jobs')
@login_required
...
@bullhorn_bp.route('/bullhorn/monitor/<int:monitor_id>/test-email', methods=['POST'])
...
@bullhorn_bp.route('/bullhorn/settings', methods=['GET', 'POST'])
@login_required
...
@bullhorn_bp.route('/api/bullhorn/connection-test', methods=['POST'])
@login_required
...
@bullhorn_bp.route('/bullhorn/oauth/start')
@login_required
...
@bullhorn_bp.route('/bullhorn/oauth/callback')
def bullhorn_oauth_callback():
    ...
    try:
        ...
        try:
            ...
            redirect_uri = f"{base_url_env}/bullhorn/oauth/callback"
...
@bullhorn_bp.route('/api/bullhorn/activities')
@login_required
...
@bullhorn_bp.route('/api/bullhorn/monitors')
@login_required
...
@bullhorn_bp.route('/api/bullhorn/monitoring-cycles', methods=['GET'])
@login_required
...
@bullhorn_bp.route('/api/bullhorn/api-status', methods=['GET'])
@login_required
